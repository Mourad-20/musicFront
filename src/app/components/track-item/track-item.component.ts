...
@Component({
  ...
  template: `
    <div class="track-item" [class.active]="isCurrentTrack()" (click)="playTrack()">
      <div class="left">
        <div class="cover-wrapper">
          <img [src]="track.coverUrl" [alt]="track.title" class="cover">
        ...
        <div class="info">
          <div class="title text-ellipsis" [class.active-text]="isCurrentTrack()">{{ track.title }}</div>
          <div class="artist text-ellipsis">{{ track.artist }}</div>
        </div>
      </div>
...
export class TrackItemComponent {
  ...
  isFavorite = computed(() => this.musicService.isFavorite(this.track.id));
  ...
  toggleFavorite(event: Event): void {
    ...
    this.musicService.toggleFavorite(this.track.id);
  }
